...
public enum  SerialNumberEnums {
    ...
    rolle1("f(x)f‘(x)","0"),
    conclusion_def_integral("定积分计算结论","0"),
    partial_integration_indef_integral("定积分的分部积分法","0"),
    substitution_method_def_integral("定积分的换元积分法","0"),
    newton_leibniz_formula("牛顿-莱布尼茨公式","0"),
    partial_integration_method("分部积分法","0"),
    substitution_method_sum("换元法总结","0"),
    substitution_method("换元法","0"),
    make_differential("凑微分法","0"),
