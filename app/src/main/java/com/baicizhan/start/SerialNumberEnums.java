...
public enum  SerialNumberEnums {
    ...
    rolle1("f(x)f‘(x)","0"),
    convergence_divergence_of_unbounded_func("无界函数的反常积分的概念和敛散性","0"),
    convergence_divergence_of_infinite_intervals("无穷区间的反常积分的概念和敛散性","0"),
    derivative_variable_limit_integral("变限积分求导公式","0"),
    variable_limit_integral_properties("变限积分性质","0"),
    variable_limit_integral_concept("变限积分概念","0"),
    definte_integral_properties("定积分性质","0"),
    definte_integral_exist("定积分存在定理","0"),
    definite_integral_concept("定积分的概念","0"),
    indefinte_integral_exist("不定积分存在定理","0"),
    indefinite_integral_concept("不定积分的概念","0"),
